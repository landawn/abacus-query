...
public class LeftJoinTest extends TestBase {
    ...
    public void testConstructorWithComplexCondition() {
        Condition condition = CF.and(
            CF.eq("c.customer_id", "o.customer_id"),
            CF.eq("o.status", "active")
        );
    ...
    public void testConstructorWithMultipleEntities() {
        ...
        Condition condition = CF.and(
            CF.eq("c.id", "o.customer_id"),
            CF.eq("o.id", "oi.order_id")
        );
    ...
    public void testTypicalUseCases() {
        ...
        LeftJoin optionalData = new LeftJoin("customer_preferences cp",
            CF.eq("c.id", "cp.customer_id"));
