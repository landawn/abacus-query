...
public class SomeTest extends TestBase {
    ...
    public void testWithComplexSubQuery() {
        SubQuery subQuery = CF.subQuery("departments", 
            Arrays.asList("budget"), 
            CF.and(CF.eq("active", true), CF.gt("year", 2023)));
        Some some = CF.some(subQuery);
    ...
    public void testClearParameters() {
        SubQuery subQuery = CF.subQuery("scores", 
            Arrays.asList("value"), 
            CF.between("date", "2023-01-01", "2023-12-31"));
        Some some = CF.some(subQuery);
    ...
    public void testCopy() {
        SubQuery subQuery = CF.subQuery("salaries", 
    ...
    public void testPracticalExample2() {
        ...
        SubQuery competitorPrices = CF.subQuery("competitor_products", 
            Arrays.asList("price"), 
            CF.eq("category", "electronics"));
    ...
    public void testPracticalExample3() {
        ...
        SubQuery deptBudgets = CF.subQuery("departments", 
            Arrays.asList("budget"), 
            CF.and(CF.eq("active", true), CF.gt("fiscal_year", 2023)));
