...
public class XORTest extends TestBase {
    ...
    public void testConstructorWithStringAndObject() {
        ...
        XOR xor1 = ConditionFactory.xor("isPremium", true);
        ...
        XOR xor2 = ConditionFactory.xor("status", "active");
        ...
        XOR xor3 = ConditionFactory.xor("hasDiscount", null);
        ...
        XOR xor4 = ConditionFactory.xor("level", 5);
    ...
    public void testToString() {
        XOR xor = ConditionFactory.xor("hasGoldMembership", true);
    ...
    public void testEquals() {
        XOR xor1 = ConditionFactory.xor("isPremium", true);
        XOR xor2 = ConditionFactory.xor("isPremium", true);
        XOR xor3 = ConditionFactory.xor("isPremium", false);
        XOR xor4 = ConditionFactory.xor("isTrial", true);
