...
public class AbstractQueryBuilder2025Test extends TestBase {
    ...
    public void testPSCSelectFrom() {
        String sql = SQLBuilder.PSC.select("id", "firstName", "lastName")
                .from(Account.class)
                .sql();
        assertNotNull(sql);
    ...
    public void testPSCWithWhere() {
        String sql = SQLBuilder.PSC.select("id", "firstName")
                .from(Account.class)
    ...
    public void testPSCWithDistinct() {
        String sql = SQLBuilder.PSC.select("status")
                .from(Account.class)
                .distinct()
                .sql();
        assertNotNull(sql);
    ...
    public void testInsertInto() {
        String sql = SQLBuilder.PSC.insertInto(Account.class)
                .sql();
        assertNotNull(sql);
    ...
    public void testSelectWithAlias() {
        String sql = SQLBuilder.PSC.select("firstName AS fname", "lastName AS lname")
                .from(Account.class)
                .sql();
        assertNotNull(sql);
    ...
    public void testOrderByDesc() {
        String sql = SQLBuilder.PSC.select("*")
                .from(Account.class)
                .orderBy("createdTime", SortDirection.DESC)
                .sql();
        assertNotNull(sql);
        assertTrue(sql.contains("ORDER BY"));
    }
    ...
    public void testJoinWithEntityClass() {
        String sql = SQLBuilder.PSC.select("*")
                .from(Account.class)
                .join(Account.class).on("a.id = b.parent_id")
                .sql();
        assertNotNull(sql);
    }
    ...
    public void testIntoWithTableName() {
        String sql = SQLBuilder.PSC.insert("id", "name").into("accounts")
                .sql();
        assertNotNull(sql);
        assertTrue(sql.contains("INSERT INTO"));
    }
    ...
    public void testUpdateWithSet() {
        String sql = SQLBuilder.PSC.update("accounts")
                .set("status", "inactive")
                .set("updated_at", "NOW()")
                .where(ConditionFactory.eq("id", 1))
                .sql();
    ...
    public void testDeleteFromWithTable() {
        String sql = SQLBuilder.PSC.deleteFrom("accounts")
                .where(ConditionFactory.eq("status", "deleted"))
                .sql();
        assertNotNull(sql);
        assertTrue(sql.contains("DELETE FROM"));
    }
    ...
    public void testSelectCount() {
        String sql = SQLBuilder.PSC.select(AbstractQueryBuilder.COUNT_ALL)
                .from(Account.class)
                .sql();
        assertNotNull(sql);
    ...
    public void testSelectAll() {
        String sql = SQLBuilder.PSC.select(AbstractQueryBuilder.ALL)
                .from(Account.class)
                .sql();
        assertNotNull(sql);
    }
