...
public class SQLBuilder11Test extends TestBase {
    ...
    public class SCSBTest {
        ...
        public void testUpdateTableName() {
            ...
            String sql = sb.set("status", "'ACTIVE'").where(Filters.eq("id", 1)).sql();
            Assertions.assertNotNull(sql);
        ...
        public void testUpdateEntityClass() {
            ...
            Assertions.assertDoesNotThrow(() -> sb.set("status").where(Filters.eq("id", 1)).sql());
        }
        ...
        public void testDeleteFromTableName() {
            ...
            String sql = sb.where(Filters.eq("status", "'DELETED'")).sql();
            Assertions.assertNotNull(sql);
    ...
    public class ACSBTest {
        ...
        public void testUpdateTableNameWithEntityClass() {
            ...
            String sql = sb.set("status").where(Filters.eq("id", 1)).sql();
            Assertions.assertNotNull(sql);
        }
        ...
        public void testDeleteFromTableName() {
            ...
            String sql = sb.where(Filters.eq("status", "'INACTIVE'")).sql();
            Assertions.assertNotNull(sql);
            Assertions.assertTrue(sql.contains("DELETE FROM"));
        }
    ...
    public class LCSBTest extends TestBase {
        ...
        public void testUpdateTableName() {
            ...
            String sql = sb.set("status", "'PREMIUM'").where(Filters.gt("totalPurchases", 1000)).sql();
            Assertions.assertNotNull(sql);
            Assertions.assertTrue(sql.contains("UPDATE"));
        }
        ...
        public void testUpdateTableNameWithEntityClass() {
            ...
            String sql = sb.set("status").where(Filters.eq("customerId", 100)).sql();
            Assertions.assertNotNull(sql);
        }
        ...
        public void testUpdateEntityClass() {
            ...
            Assertions.assertDoesNotThrow(() -> sb.set("status").where(Filters.eq("customerId", 100)).sql());
        }
        ...
        public void testDeleteFromTableNameWithEntityClass() {
            ...
            String sql = sb.where(Filters.lt("lastLoginDate", "2020-01-01")).sql();
            Assertions.assertNotNull(sql);
        }
        ...
        public void testDeleteFromEntityClass() {
            ...
            String sql = sb.where(Filters.isNull("emailAddress")).sql();
            Assertions.assertNotNull(sql);
        }
