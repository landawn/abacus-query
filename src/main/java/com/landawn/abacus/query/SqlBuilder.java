 ...
 * The class name encodes both the parameter style and the identifier naming policy. The parameter style is
 * given by a leading {@code P} (positional {@code ?}), {@code N} (named {@code :name}), or {@code M}
 * (MyBatis/iBATIS {@code #{name}}); the raw/un-parameterized family (which inlines literal values) has no
 * such leading style letter and instead ends in the literal {@code SB}. The naming policy is encoded by a
 * two-letter code: {@code SB}=no change, {@code SC}=snake_case, {@code AC}=UPPER_CASE_WITH_UNDERSCORE,
...
public abstract class SqlBuilder extends AbstractQueryBuilder<SqlBuilder> { // NOSONAR
     ...
     * <pre>{@code
     * SCSB.select("firstName", "lastName").from("account").where(Filters.equal("id", 1)).build().query();
    ...
    public static class SCSB extends SqlBuilder {
         ...
         * String sql = SCSB.insert(props).into("account").build().query();
         ...
         * String sql = SCSB.insert(account).into("account").build().query();
         ...
         * String sql = SCSB.insert(account, excluded).into("account").build().query();
         * // Output: INSERT INTO account (first_name, email) VALUES ('John', 'john@email.com')
         * }</pre>
         *
         * @param entity the entity object to insert
         ...
         * );
         * String sql = SCSB.batchInsert(accounts).into("account").build().query();
    ...
    /**
     * Un-parameterized SQL builder with UPPER_CASE_WITH_UNDERSCORE (SCREAMING_SNAKE_CASE) field/column naming strategy.
     *
     * <p>This builder generates SQL with actual values embedded directly in the SQL string. Property names
     ...
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * LCSB.select("firstName", "lastName").from("userAccount").where(Filters.equal("userId", 1)).build().query();
    ...
    public static class LCSB extends SqlBuilder {
         ...
         * props.put("age", 30);
         * String sql = LCSB.insert(props).into("users").build().query();
         ...
         * String sql = LCSB.insert(user).into("users").build().query();
         ...
         * User user = new User("John", "Doe", "john@example.com");
         * Set<String> excluded = new HashSet<>(Arrays.asList("createdDate", "modifiedDate"));
         * String sql = LCSB.insert(user, excluded).into("users").build().query();
         * // Output: INSERT INTO users (firstName, lastName, email) VALUES ('John', 'Doe', 'john@example.com')
         * }</pre>
         * 
         * @param entity the entity object to insert
         ...
         * 
         * <p>This method generates an INSERT template for the specified entity class,
         * excluding the specified properties. Properties marked with {@code @ReadOnly},
         * {@code @ReadOnlyId}, or {@code @Transient} annotations
         ...
         *     new User("Jane", "Smith")
         * );
         * String sql = LCSB.batchInsert(users).into("users").build().query();
         ...
         * Properties marked with {@code @ReadOnly}, {@code @NonUpdatable}, or
         * {@code @Transient} annotations are always excluded.
    ...
    public static class PSB extends SqlBuilder {
         ...
         * 
         * <p>All insertable properties of the entity (those not marked with {@code @Transient},
         * {@code @ReadOnly}, or {@code @ReadOnlyId}) will be included in the INSERT statement.</p>
         *
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         ...
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * String sql = PSB.count(User.class)
         *                 .where(Filters.like("email", "%@example.com"))
         *                 .build().query();
         * // Output: SELECT count(*) FROM User WHERE email LIKE ?
         * }</pre>
         *
    ...
    public static class PAC extends SqlBuilder {
         ...
         * <pre>{@code
         * // If User has an Address sub-entity
         * String sql = PAC.select(User.class, true).from("users").build().query();
         ...
         * String sql = PAC.select(User.class, exclude).from("users").build().query();
         ...
         * <pre>{@code
         * Set<String> exclude = new HashSet<>(Arrays.asList("password"));
         * String sql = PAC.selectFrom(User.class, exclude).build().query();
         ...
         * <pre>{@code
         * Set<String> exclude = new HashSet<>(Arrays.asList("password"));
         * String sql = PAC.selectFrom(User.class, true, exclude).build().query();
    ...
    public static class PLC extends SqlBuilder {
         ...
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * String sql = PLC.insert("firstName").into("account").build().query();
         ...
         *                 .into("account")
         *                 .build();
         * // sqlPair.query(): INSERT INTO account (firstName, lastName, email) VALUES (?, ?, ?)
         * }</pre>
         * 
         * @param propOrColumnNames the property or column names to insert
         * @return a new SqlBuilder instance configured for INSERT operation
         ...
         * <pre>{@code
         * List<String> columns = Arrays.asList("firstName", "lastName", "email");
         * String sql = PLC.insert(columns).into("account").build().query();
         * // Output: INSERT INTO account (firstName, lastName, email) VALUES (?, ?, ?)
         * 
         * // Dynamic column selection
         * List<String> requiredFields = getRequiredFields();
         * String sql = PLC.insert(requiredFields).into("userProfile").build().query();
         * }</pre>
         * 
         * @param propOrColumnNames collection of property or column names to insert
         * @return a new SqlBuilder instance configured for INSERT operation
         ...
         * // sqlPair.query(): INSERT INTO account (firstName, lastName, email, isActive) VALUES (?, ?, ?, ?)
         ...
         * Creates an INSERT statement from an entity object.
         * 
         * <p>This method includes all insertable properties of the entity (those not marked with
         * {@code @Transient}, {@code @ReadOnly}, or {@code @ReadOnlyId}).
         ...
         * // sqlPair.query(): INSERT INTO account (firstName, lastName, email, createdDate) VALUES (?, ?, ?, ?)
         ...
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * String sql = PLC.insert(Account.class).into("account").build().query();
         ...
         * String sql = PLC.insert(Account.class, excluded).into("account").build().query();
         * // Output: INSERT INTO account (firstName, lastName, email) VALUES (?, ?, ?)
         * 
         * // Exclude computed fields
         * Set<String> computed = N.asSet("fullName", "age", "accountBalance");
         * String sql2 = PLC.insert(Customer.class, computed).into("customer").build().query();
         * }</pre>
         * 
         * @param entityClass the entity class to generate INSERT for
         * @param excludedPropNames set of property names to exclude from the insert
         ...
         * String sql = PLC.insertInto(Account.class).build().query();
         * // Output: INSERT INTO account (firstName, lastName, email) VALUES (?, ?, ?)
         * 
         ...
         * 
         * String sql2 = PLC.insertInto(Account.class).build().query();
         ...
         * String sql = PLC.insertInto(Account.class, excluded).build().query();
         * // Output: INSERT INTO account (firstName, lastName, email) VALUES (?, ?, ?)
         * 
         ...
         *                 .where(Filters.equal("id", account.getId()))
         *                 .build();
         * // sqlPair.query(): UPDATE account SET firstName = ?, lastName = ?, modifiedDate = ? WHERE id = ?
         * }</pre>
         * 
         * @param tableName the name of the table to update
         * @param entityClass the entity class for property mapping
         ...
         *     cols.add("email");
         * }
         * String sql2 = PLC.select(cols).from("account").build().query();
         * 
         * // From entity metadata
         * List<String> entityColumns = getEntityColumns(Account.class);
         * String sql3 = PLC.select(entityColumns).from("account").build().query();
         * }</pre>
         * 
         * @param propOrColumnNames collection of property or column names to select
         * @return a new SqlBuilder instance configured for SELECT operation
         ...
         * columnAliases.put("firstName", "fname");
         * columnAliases.put("lastName", "lname");
         * columnAliases.put("email", "userEmail");
         *
         * String sql = PLC.select(columnAliases)
         *                 .from("account")
         *                 .build().query();
         * // Output: SELECT firstName AS "fname", lastName AS "lname", email AS "userEmail" FROM account
         * 
         ...
         * // Output: (firstName = ?) AND (email LIKE ?)
         * }</pre>
         *
         * @param cond the condition to render (must not be {@code null})
         * @param entityClass the entity class used for property-to-column mapping (may be {@code null})
    ...
    public static class NSB extends SqlBuilder {
        ...
        /**
         * Indicates whether this builder generates SQL with named parameters.
         *
         * @return {@code true}, as this builder always generates named SQL
         */
        @Override
         ...
         * Creates an INSERT SQL builder from an entity object.
         * 
         * <p>This method extracts all insertable properties from the entity object to create the INSERT statement.
         ...
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * String sql = NSB.selectFrom(User.class).where(Filters.equal("active", true)).build().query();
         ...
         * String sql = NSB.selectFrom(Order.class, true, exclude).build().query();
         ...
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * String sql = NSB.count("users").where(Filters.equal("active", true)).build().query();
    ...
    public static class NSC extends SqlBuilder {
         ...
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * String sql = NSC.select(User.class).from("users").where(Filters.equal("active", true)).build().query();
         ...
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * String sql = NSC.selectFrom(User.class).where(Filters.equal("id", 1)).build().query();
         ...
         * <pre>{@code
         * Set<String> excluded = Set.of("password");
         * String sql = NSC.selectFrom(User.class, excluded).where(Filters.equal("active", true)).build().query();
         ...
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * String sql = NSC.count("users").where(Filters.equal("active", true)).build().query();
         * // Output: SELECT count(*) FROM users WHERE active = :active
         * }</pre>
         * 
         * @param tableName the name of the table to count rows from
    ...
    /**
     * Named SQL builder with UPPER_CASE_WITH_UNDERSCORE (SCREAMING_SNAKE_CASE) field/column naming strategy.
    ...
    public static class NAC extends SqlBuilder {
         ...
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * String sql = NAC.insert("firstName", "lastName").into("ACCOUNT").build().query();
         * // Output: INSERT INTO ACCOUNT (FIRST_NAME, LAST_NAME) VALUES (:firstName, :lastName)
         * }</pre>
         * 
         * @param propOrColumnNames the property or column names to insert
         ...
         * String sql = NAC.insert(account, Set.of("createdTime")).into("ACCOUNT").build().query();
         * // Output: INSERT INTO ACCOUNT (FIRST_NAME, LAST_NAME) VALUES (:firstName, :lastName)
         * }</pre>
         * 
         * @param entity the entity object to insert
         ...
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * String sql = NAC.insert(Account.class, Set.of("id", "createdTime")).into("ACCOUNT").build().query();
         * // Output: INSERT INTO ACCOUNT (FIRST_NAME, LAST_NAME, EMAIL) VALUES (:firstName, :lastName, :email)
         * }</pre>
         * 
         * @param entityClass the entity class
         ...
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * String sql = NAC.insertInto(Account.class, Set.of("id")).build().query();
         * // Output: INSERT INTO ACCOUNT (FIRST_NAME, LAST_NAME, EMAIL) VALUES (:firstName, :lastName, :email)
         * }</pre>
         * 
         * @param entityClass the entity class
         ...
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * String sql = NAC.count("ACCOUNT").where(Filters.equal("STATUS", "ACTIVE")).build().query();
         * // Output: SELECT count(*) FROM ACCOUNT WHERE STATUS = :STATUS
         * 
         * String sql2 = NAC.count("ORDER").where(Filters.greaterThan("AMOUNT", 100)).build().query();
         ...
         * Renders a condition as a standalone SQL fragment, using the given entity class for property-to-column mapping.
         *
         * <p>This method is useful for generating just the SQL fragment for a condition.</p>
         *
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * Condition cond = Filters.and(
     ...
     * <pre>{@code
     * // Simple SELECT with named parameters
     * N.println(NLC.select("firstName", "lastName").from("account").where(Filters.equal("id", 1)).build().query());
    ...
    public static class NLC extends SqlBuilder {
         ...
         * data.put("lastName", "Doe");
         * data.put("age", 30);
         * String sql = NLC.insert(data).into("account").build().query();
         ...
         * String sql1 = NLC.select(Order.class, false).from("orders").build().query();
         * // Output: SELECT id, orderNumber, amount, status FROM orders
         * 
         * // With sub-entity properties (if Order has an Account sub-entity)
         * String sql2 = NLC.select(Order.class, true).from("orders").build().query();
    ...
    public static class MSB extends SqlBuilder {
         ...
         * data.put("name", "John");
         * data.put("age", 30);
         * String sql = MSB.insert(data).into("users").build().query();
         ...
         * <pre>{@code
         * User user = new User("John", "Doe", "john@example.com");
         * String sql = MSB.insert(user).into("users").build().query();
         * // Output: INSERT INTO users (firstName, lastName, email) 
         * //         VALUES (#{firstName}, #{lastName}, #{email})
         * }</pre>
         * 
         ...
         * User user = new User();
         * Set<String> exclude = new HashSet<>(Arrays.asList("createdDate", "modifiedDate"));
         * String sql = MSB.insert(user, exclude).into("users").build().query();
         * }</pre>
         * 
         * @param entity the entity object containing data to insert
         * @param excludedPropNames set of property names to exclude from the INSERT
         ...
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * String sql = MSB.insert(User.class).into("users").build().query();
         ...
         * <pre>{@code
         * Set<String> exclude = new HashSet<>(Arrays.asList("id", "version"));
         * String sql = MSB.insert(User.class, exclude).into("users").build().query();
         * }</pre>
         * 
         * @param entityClass the entity class to generate INSERT for
         * @param excludedPropNames set of property names to exclude
         ...
         * public class User { ... }
         * 
         * String sql = MSB.insertInto(User.class).build().query();
         * // Output: INSERT INTO users (firstName, lastName, email) 
         * //         VALUES (#{firstName}, #{lastName}, #{email})
         * }</pre>
         * 
         ...
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * String sql = MSB.select(User.class).from("users").build().query();
         * // Output: SELECT id, firstName, lastName, email FROM users
         * }</pre>
         * 
         * @param entityClass the entity class to select from
         ...
         * String sql = MSB.select(User.class, true).from("users").build().query();
         ...
         * String sql = MSB.select(User.class, exclude).from("users").build().query();
         * // Output: SELECT id, firstName, lastName, email FROM users
         ...
         * );
         * String sql = MSB.select(selections).from(...).build().query();
         * }</pre>
         * 
         * @param multiSelects list of Selection configurations for each entity
         * @return a new SqlBuilder instance configured for SELECT operation
     ...
     * account.setFirstName("John");
     * account.setLastName("Doe");
     * String sql = MSC.insert(account).into("account").build().query();
     * // Output: INSERT INTO account (first_name, last_name) VALUES (#{firstName}, #{lastName})
     * }</pre>
     * 
    ...
    public static class MSC extends SqlBuilder {
         ...
         * String sql = MSC.select(User.class, true, exclude).from("users").build().query();
    ...
    /**
     * MyBatis-style SQL builder with UPPER_CASE_WITH_UNDERSCORE (SCREAMING_SNAKE_CASE) field/column naming strategy.
     *
    ...
    public static class MAC extends SqlBuilder {
         ...
         * All insertable properties of the entity (those not marked with {@code @Transient},
         * {@code @ReadOnly}, or {@code @ReadOnlyId}) will be included in the INSERT statement.
         *
         ...
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * String sql = MAC.select(Account.class).from("ACCOUNT").build().query();
         ...
         * <pre>{@code
         * // Without sub-entities
         * String sql = MAC.select(Order.class, false).from("ORDERS").build().query();
         ...
         * String sql = MAC.select(Order.class, true).from("ORDERS").build().query();
         * }</pre>
         *
         * @param entityClass the entity class to select properties from
         ...
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * String sql = MAC.selectFrom(Account.class).where(Filters.equal("isActive", true)).build().query();
         ...
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * String sql = MAC.count("ACCOUNT").where(Filters.equal("isActive", true)).build().query();
         ...
         * Renders a condition as a standalone SQL fragment, using the given entity class for property-to-column mapping.
         *
         * <p>This is useful for generating WHERE clause fragments with SCREAMING_SNAKE_CASE naming.</p>
         *
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * Condition cond = Filters.and(
    ...
    public static class MLC extends SqlBuilder {
         ...
         * @return a new SqlBuilder instance configured for UPDATE operation
         * @throws IllegalArgumentException if tableName is null or empty, or if {@code entityClass} is null
         */
        public static SqlBuilder update(final String tableName, final Class<?> entityClass) {
            N.checkArgNotEmpty(tableName, UPDATE_PART_MSG);
            N.checkArgNotNull(entityClass, UPDATE_PART_MSG);
         ...
         * Renders a condition as a standalone SQL fragment, using the given entity class for property-to-column mapping.
         *
         * <p>This method is useful for generating SQL fragments from condition objects.</p>
         *
         * <p><b>Usage Examples:</b></p>
         * <pre>{@code
         * Condition cond = Filters.and(
