 ...
 *   <li>For a nonempty subquery, a true ALL comparison also makes ANY/SOME true; for an empty
 *       subquery, ANY/SOME is false while ALL is true</li>
 * </ul>
 *
 ...
 * @see ComposableCell
 */
public class Any extends ComposableCell {
