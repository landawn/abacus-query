...
public class Having extends Clause {
     ...
     * Multiple conditions can be combined using composable operators (AND, OR, NOT)
     ...
     *             An empty {@link Junction} is accepted and renders its Boolean identity (for example {@code HAVING 1 = 0})
     */
