...
[![Javadocs](https://img.shields.io/badge/javadoc-1.3.23-brightgreen.svg)](https://www.javadoc.io/doc/com.landawn/abacus-query/1.3.23/index.html)
...
```gradle
// JDK 1.8 or above:
compile 'com.landawn:abacus-query:1.3.23'
```
