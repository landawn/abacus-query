...
[![Javadocs](https://img.shields.io/badge/javadoc-4.9.3-brightgreen.svg)](https://www.javadoc.io/doc/com.landawn.abacus/abacus-query/4.9.3/index.html)
...
```groovy
implementation 'com.landawn.abacus:abacus-query:4.9.3'
```
...
- **API docs (Javadoc)** — https://www.javadoc.io/doc/com.landawn.abacus/abacus-query/4.9.3/index.html
