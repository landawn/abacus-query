...
[![Javadocs](https://img.shields.io/badge/javadoc-2.3.2-brightgreen.svg)](https://www.javadoc.io/doc/com.landawn/abacus-query/2.3.2/index.html)
...
```gradle
// JDK 1.8 or above:
compile 'com.landawn:abacus-query:2.3.2'
```
