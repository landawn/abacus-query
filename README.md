...
[![Javadocs](https://img.shields.io/badge/javadoc-3.26.7-brightgreen.svg)](https://www.javadoc.io/doc/com.landawn/abacus-query/3.26.7/index.html)
...
```gradle
// JDK 17 or above:
compile 'com.landawn:abacus-query:3.26.7'
```
