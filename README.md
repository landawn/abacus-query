...
[![Javadocs](https://img.shields.io/badge/javadoc-3.2.7-brightgreen.svg)](https://www.javadoc.io/doc/com.landawn/abacus-query/3.2.7/index.html)
...
```gradle
// JDK 1.8 or above:
compile 'com.landawn:abacus-query:3.2.7'
```
