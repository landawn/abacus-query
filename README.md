...
[![Javadocs](https://img.shields.io/badge/javadoc-2.0.6-brightgreen.svg)](https://www.javadoc.io/doc/com.landawn/abacus-query/2.0.6/index.html)
...
```gradle
// JDK 1.8 or above:
compile 'com.landawn:abacus-query:2.0.6'
```
