...
[![Javadocs](https://img.shields.io/badge/javadoc-4.8.11-brightgreen.svg)](https://www.javadoc.io/doc/com.landawn.abacus/abacus-query/4.8.11/index.html)
...
```groovy
implementation 'com.landawn.abacus:abacus-query:4.8.11'
```
...
- **API docs (Javadoc)** — https://www.javadoc.io/doc/com.landawn.abacus/abacus-query/4.8.11/index.html
