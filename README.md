...
[![Javadocs](https://img.shields.io/badge/javadoc-4.6.0-brightgreen.svg)](https://www.javadoc.io/doc/com.landawn/abacus-query/4.6.0/index.html)
...
```gradle
// JDK 17 or above:
compile 'com.landawn:abacus-query:4.6.0'
```
