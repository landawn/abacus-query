...
[![Javadocs](https://img.shields.io/badge/javadoc-4.8.10-brightgreen.svg)](https://www.javadoc.io/doc/com.landawn.abacus/abacus-query/4.8.10/index.html)
...
```groovy
implementation 'com.landawn.abacus:abacus-query:4.8.10'
```
...
- **API docs (Javadoc)** — https://www.javadoc.io/doc/com.landawn.abacus/abacus-query/4.8.10/index.html
