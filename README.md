...
[![Javadocs](https://img.shields.io/badge/javadoc-4.9.2-brightgreen.svg)](https://www.javadoc.io/doc/com.landawn.abacus/abacus-query/4.9.2/index.html)
...
```groovy
implementation 'com.landawn.abacus:abacus-query:4.9.2'
```
...
List<String> tokens = SqlParser.tokenize("SELECT a, b FROM t WHERE a >= 1");
...
- **API docs (Javadoc)** — https://www.javadoc.io/doc/com.landawn.abacus/abacus-query/4.9.2/index.html
