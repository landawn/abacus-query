...
[![Maven Central](https://img.shields.io/maven-central/v/com.landawn.abacus/abacus-query.svg)](https://central.sonatype.com/artifact/com.landawn.abacus/abacus-query/4.8.6)
[![Javadocs](https://img.shields.io/badge/javadoc-4.8.6-brightgreen.svg)](https://www.javadoc.io/doc/com.landawn.abacus/abacus-query/4.8.6/index.html)
...
```gradle
// JDK 17 or above:
compile 'com.landawn.abacus:abacus-query:4.8.6'
```
