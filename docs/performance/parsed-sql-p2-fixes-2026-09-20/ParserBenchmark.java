...
public class ParserBenchmark {
    ...
    public static void main(String[] args) throws Exception {
        ...
        cases.add(new Case("json_query_format",1,0,1000));
        cases.add(new Case("unary_quoted_cast",1,1,1000));
    ...
    static String sql(Case c,long id) {
        ...
        return switch(c.shape) {
            ...
            case "json_query_format" -> "SELECT JSON_ARRAY(SELECT payload ? format JSON FROM t)"+a;
            case "unary_quoted_cast" -> "SELECT ?- ?:: \"line\""+a;
